...
- An externally available server or instance to run this on
  - If you don't have a spare computer or server lying around, don't worry!
    ...
    them anymore, but I think the [$3.50/month starter
...
You'll also need to run `chown 999:999 -R postgres` for PostgreSQL. If you have
...
[olivia@sculley.dev](mailto:olivia@sculley.dev) and I'll be more than happy to
take a look!
